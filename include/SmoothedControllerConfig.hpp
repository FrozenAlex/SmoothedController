...
DECLARE_CONFIG(SmoothedControllerConfig) {
    ...
    CONFIG_VALUE(
        SmallMovementThresholdAngle,
        float,
        "SmallMovementThresholdAngle",
        6.f,
        "Angle difference to consider a 'small' movement. The less shaky your hands are the lower you probably want to put this. This is probably the primary value you want to tweak"
    );
};
